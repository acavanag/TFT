...
class StockFormatter(GenericDataFormatter):
  ...
  _column_definition = [
      ...
      ('SMA_50', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
      ('SMA_200', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
      ('BBL_5_2_0', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
      ('BBM_5_2_0', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
      ('BBU_5_2_0', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
      ('BBB_5_2_0', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
      ('BBP_5_2_0', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
      ('RSI_14', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
      ('MACD_12_26_9', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
      ('MACDh_12_26_9', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
      ('MACDs_12_26_9', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
      ('OBV', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
      ('NATR_14', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
